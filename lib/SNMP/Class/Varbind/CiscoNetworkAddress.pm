package SNMP::Class::Varbind::CiscoNetworkAddress;
...
sub matches {
	...
	&& 
	( SNMP::Class::Utils::textual_convention_of( $_[0]->get_label ) eq 'CiscoNetworkAddress')
	;
...
sub priority {
	return unpack 'n',$_[0]->raw_value;
}

sub mac_address {
	return uc join(':',(unpack 'n(H2)*',$_[0]->raw_value)[1..6]);
}
